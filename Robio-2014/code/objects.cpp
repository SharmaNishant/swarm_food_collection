...
int main( int argc, char** argv )
{
    ...
    ros::Subscriber simDet = node.subscribe("simulationDetails", 5000, simulationDetails);
    ros::Subscriber simCom = node.subscribe("simulationCommand", 10, simulationCommand);
